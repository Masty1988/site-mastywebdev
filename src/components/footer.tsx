    ...
    <footer className="bg-slate-900 text-white py-12 border-t border-slate-800">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            <li>
              <a href="https://www.malt.fr/profile/nicolaslesieur1" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-3 group">
                {/* Icône Malt (Point Rouge Brandé) */}
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="12" r="10" fill="#FF3D4F" className="group-hover:fill-red-500 transition-colors"/>
                </svg>
                <span>Malt</span>
              </a>
            </li>
            <li>
              <a href="https://github.com/Masty1988" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-3">
                {/* Icône GitHub */}
            ...
            <li>
              <a href="https://www.linkedin.com/in/nicolas-mastywebdev/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-3">
                {/* Icône LinkedIn */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
